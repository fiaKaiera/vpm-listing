...
> [!NOTE]
> We recommend using the [ALCOM](https://vrc-get.anatawa12.com/en/alcom/) so you can add these packages in your VRChat project without much hassle.
> <br>[VRChat Creator Companion](https://vrchat.com/home/download) will still work fine.
> 
...
- [**Real-ish Doors**](Packages/net.fiakaiera.door) v1.1.1 
...
[ [*.unitypackage](https://github.com/fiaKaiera/vpm-listing/releases/download/door-1.1.1/net.fiakaiera.door-1.1.1.unitypackage) ]
[ [*.zip](https://github.com/fiaKaiera/vpm-listing/releases/download/door-1.1.1/net.fiakaiera.door-1.1.1.zip) ]
